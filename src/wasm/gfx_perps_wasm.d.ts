...
* @returns {Fractional}
*/
export function get_funding_rate(market_product_group_byte: Uint8Array, trader_risk_group_byte: Uint8Array, product_index: bigint): Fractional;
/**
* @param {Uint8Array} market_product_group
* @param {Uint8Array} trader_risk_group
* @returns {Fractional}
...
*/
export function get_user_transfers(trader_risk_group_byte: Uint8Array): FundsTransfer;
/**
...
/**
*/
  deposited: Fractional;
/**
*/
  withdrawn: Fractional;
}
/**
