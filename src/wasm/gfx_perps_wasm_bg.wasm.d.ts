...
export function __wbg_fundstransfer_free(a: number): void;
export function __wbg_get_fundstransfer_deposited(a: number): number;
export function __wbg_set_fundstransfer_deposited(a: number, b: number): void;
export function __wbg_get_fundstransfer_withdrawn(a: number): number;
export function __wbg_set_fundstransfer_withdrawn(a: number, b: number): void;
...
export function get_funding_rate(a: number, b: number, c: number, d: number, e: number, f: number): void;
...
export function get_user_transfers(a: number, b: number, c: number): void;
